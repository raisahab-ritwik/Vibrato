package com.raisahab.shakedetector;
...
import com.raisahab.shakedetector.ShakeDetector.OnShakeListener;
	...
	public void onCreate() {
		...
		ShakeDetector.create(this, new OnShakeListener() {
            ...
            public void OnShake() { 
                ...
                if(shake_count==2){
                	Toast.makeText(getApplicationContext(), "Help Help Help.. Save me Please!!", Toast.LENGTH_LONG).show();
                	shake_count=0;
                	mp.start();
                }
                else{
                	Toast.makeText(getApplicationContext(), "Device shaken !: "+ (shake_count+1), Toast.LENGTH_SHORT).show();
                	shake_count++;
                }
            }
        });
